...

{
    ...
    if (self) {
        ...
        //
        self.collectionView=[[UICollectionView alloc] initWithFrame:CGRectMake(10, 50, 370, 180) collectionViewLayout:flowLayout];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //    NSArray * scrollviewArray =[NSArray arrayWithObjects:@"北京", @"天津",@"上海",@"重庆",@"黑龙江",@"吉林",@"辽宁",@"内蒙古",@"河北",@"山东",@"江苏",@"浙江",@"福建",@"台湾",@"广东",@"江西",@"湖南",@"安徽",@"湖北",@"河南",@"山西",@"宁夏",@"陕西",@"甘肃",@"青海",@"四川",@"贵州",@"云南",@"西藏",@"新疆",nil];
